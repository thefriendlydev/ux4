<div class="section solutionsIntro">
  <div class="container">
    <?= the_field('web_intro_text'); ?>

    <?php if( get_field('web_bullet_intro_text') ): ?>
      <?= the_field('web_bullet_intro_text'); ?>
    <?php endif; ?>

    <?php if( have_rows('web_bullets') ): ?>
      <div class="iconBullet">
        <?php while( have_rows('web_bullets') ): the_row(); ?>
          <div class="combo ">
    ...
    <div class="u-alignCenter">
      <a class="button button--solutionsCta" href="<?= the_field('web_cta_button_link'); ?>"><?= the_field('web_cta_button_text'); ?></a>
    </div>
  </div>
</div>


<?php if( have_rows('web_service') ): ?>
  <?php while( have_rows('web_service') ): the_row(); ?>
    <div class="section solutionService">
      <div class="container">

        <div class="service">
          <div class="icon icon-<?= the_sub_field('web_service_icon'); ?>"></div>
          <div class="service-headline"><?= the_sub_field('web_service_title'); ?></div>
          <div class="service-text"><?= the_sub_field('web_service_text'); ?></div>
        </div>

        <div class="projectServicesContainer">
          <?php $services = get_sub_field('web_service_services');
        ...
        <?php if( have_rows('web_benefits') ): ?>
          <div class="benefitsContainer">
            <div class="benefitsTitle">Benefits</div>
            <div class="iconBullet">
              <?php while( have_rows('web_benefits') ): the_row(); ?>
                <div class="combo ">
                  <div class="combo-first">
                    <div class="icon icon-bullet"></div>
                  </div>
        ...
        <?php $case_study = get_sub_field('web_case_study'); if( $case_study ):
          $post = $case_study;
          setup_postdata( $post );
        ?>
...
<?php if( get_field('web_testimonials') ): ?>
<div class="section testimonials">
  <?php $testimonials = get_field('web_testimonials');
  if( $testimonials ): ?>
    <div class="container">
