...
foreach ($options as $key => $option) {
	...
	if($option['type'] == 'padding'){
		...
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Top', 'cjpopups').'</label><input style="width:100px; text-align:center;" placeholder="'.__('Top', 'cjpopups').'" type="text" name="'.$option['id'].'[]" value="'.$top.'" /></div>';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Bottom', 'cjpopups').'</label><input style="width:100px; text-align:center;" placeholder="'.__('Bottom', 'cjpopups').'" type="text" name="'.$option['id'].'[]" value="'.$bottom.'" /></div>';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Left', 'cjpopups').'</label><input style="width:100px; text-align:center;" placeholder="'.__('Left', 'cjpopups').'" type="text" name="'.$option['id'].'[]" value="'.$left.'" /></div>';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Right', 'cjpopups').'</label><input style="width:100px; text-align:center;" placeholder="'.__('Right', 'cjpopups').'" type="text" name="'.$option['id'].'[]" value="'.$right.'" /></div>';
		$display[] = '</div>';
		$display[] = '<div class="cj-info">'.__($option['info'], 'cjpopups').'</div>';
		$display[] = '</td>';
		$display[] = '</tr>';
	...
	if($option['type'] == 'border'){
		...
		$display[] = '<td class="cj-panel padding-10-top">';
		$display[] = '<div class="clearfix">';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Top', 'cjpopups').'</label><input style="width:60px; text-align:center;" placeholder="'.__('Top', 'cjpopups').'" type="text" name="'.$option['id'].'[]" value="'.$top.'" /></div>';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Bottom', 'cjpopups').'</label><input style="width:60px; text-align:center;" placeholder="'.__('Bottom', 'cjpopups').'" type="text" name="'.$option['id'].'[]" value="'.$bottom.'" /></div>';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Left', 'cjpopups').'</label><input style="width:60px; text-align:center;" placeholder="'.__('Left', 'cjpopups').'" type="text" name="'.$option['id'].'[]" value="'.$left.'" /></div>';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Right', 'cjpopups').'</label><input style="width:60px; text-align:center;" placeholder="'.__('Right', 'cjpopups').'" type="text" name="'.$option['id'].'[]" value="'.$right.'" /></div>';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Style', 'cjpopups').'</label><input style="width:100px; text-align:center;" placeholder="'.__('Right', 'cjpopups').'" type="text" name="'.$option['id'].'[]" value="'.$style.'" /></div>';
		$display[] = '<div style="float:left; margin-right: 10px; padding-top:5px;"><label style="display:block; padding-bottom:1px; text-align:center;">'.__('Color', 'cjpopups').'</label>';
	...
	if($option['type'] == 'groupdropdown' || $option['type'] == 'groupselect'){
		$opts[] = '<option>'.__('Select', 'cjpopups').' '.__($option['label'], 'cjpopups').'</option>';
		foreach ($option['options'] as $okey => $ovalue) {
	...
	if($option['type'] == 'file_raw'){
		...
		$display[] = '<td class="cj-panel">';
		$display[] = '<div class="cj-file-upload">';
		$display[] = '<button class="button-secondary">'.__('Choose File', 'cjpopups').'</button>';
	...
	if($option['type'] == 'files_raw'){
		...
		$display[] = '<td class="cj-panel">';
		$display[] = '<div class="cj-file-upload">';
		$display[] = '<button class="button-secondary">'.__('Choose Files', 'cjpopups').'</button>';
	...
	if($option['type'] == 'sortable'){
		...
		$opts = null;
		if($option['default'] != ''){
			$opts = cjpopups_sortArrayByArray($option['options'], $option['default']);
		}else{
			$opts = $option['options'];
		}
	...
	if($option['type'] == 'submit'){
		...
		$display[] = '<input '.$params.' type="submit" id="'.$option['id'].'" name="'.$option['id'].'" value="'.__($option['label'], 'cjpopups').'" class="button-primary" />'.$option['suffix'];
		$display[] = '</td>';
		$display[] = '</tr>';
	}
